...
class Button(object):
    ...
    def __init__(self, _text, _color, _enabled, _x, _y):
        """初始化按钮方法。
    ...
    def clicked(self, _mouse_x, _mouse_y):
        ...
        Returns:
            按钮对象是否被点击。
        """
        return self.__enabled and self.__rect.collidepoint(_mouse_x, _mouse_y)
